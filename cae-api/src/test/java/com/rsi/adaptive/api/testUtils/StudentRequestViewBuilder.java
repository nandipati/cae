...
public class StudentRequestViewBuilder {
  ...
  private List<ScoreEstimationRequest> createScoreEstimation() {
    List<ScoreEstimationRequest> scoreEstimationList = new ArrayList<>();
    ScoreEstimationRequest scoreEstimation = new ScoreEstimationRequest();
